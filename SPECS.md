...
Plus simple markers (`640065`, `http://localhost:9080`, `Haus Sonnenschein`, `nicole.neckermann@icloud.com`, etc.) used by the AvailabilityCalendar and various inline texts.
